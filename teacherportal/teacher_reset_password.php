...
<title>Set New Password — Teacher Portal</title>
...
<div class="card">
  ...
  <?php if ($done): ?>
    ...
    <a href="teacher_login" style="text-decoration:none;">
  ...
  <?php elseif (!$token_valid): ?>
    ...
    <a href="teacher_forgotpassword" style="text-decoration:none;">
  ...
  <?php else: ?>
    ...
    <p class="lead">Choose a new password for your Teacher Portal account. It must be at least 8 characters.</p>

    <form method="POST" action="teacher_reset_password" data-confirm="Set this as your new password?" data-icon="question">
