...
// full Student Portal's STUDENT_SESSID.
...
<nav class="lms-navbar" id="lmsNavbar">
  <div class="lms-navbar-inner">
    <a href="<?= $base ?>learningportal/lms_home" class="lms-navbar-brand">
    ...
    <div class="lms-navbar-menu" id="lmsNavMenu">
      <div class="lms-navbar-links">
        <?php lmsNavLink($base . 'learningportal/lms_home', 'Home', $current, 'lms_home.php'); ?>
        <?php lmsNavLink($base . 'learningportal/my_courses', 'My Courses', $current, 'my_courses.php'); ?>
        ...
        <div class="lms-nav-dropdown" id="lmsAcademicsDropdown">
          ...
          <div class="lms-nav-dropdown-panel">
            <?php lmsNavLink($base . 'learningportal/student_lessons', 'Lessons', $current, 'student_lessons.php'); ?>
            <?php lmsNavLink($base . 'learningportal/student_discussions', 'Discussions', $current, 'student_discussions.php'); ?>
            <?php lmsNavLink($base . 'learningportal/student_assignments', 'Assignments', $current, 'student_assignments.php'); ?>
            <?php lmsNavLink($base . 'learningportal/student_quizzes', 'Quizzes', $current, 'student_quizzes.php'); ?>
          </div>
        </div>
      </div>
      ...
      <div class="student-topbar-profile-wrapper" id="studentProfileWrapper">
        <button type="button" class="student-topbar-profile" id="studentProfileToggle" aria-haspopup="true" aria-expanded="false">
          <span class="student-topbar-profile-avatar">
            <?php if (!empty($sb_photo_path)): ?>
              <img src="<?= $base ?>studentportal/student_photo?portal=lms" alt="" style="width:100%;height:100%;border-radius:50%;object-fit:cover;">
            <?php else: ?>
        ...
        <div class="student-profile-dropdown" id="studentProfileDropdown">
          <a href="<?= $base ?>studentportal/student_profile?portal=lms" class="student-profile-dropdown-item"><span>Profile</span></a>
          <a href="<?= $base ?>learningportal/lms_logout" class="student-profile-dropdown-item student-profile-dropdown-logout" id="studentLogoutBtn"><span>Logout</span></a>
        </div>
      </div>
    </div>
  </div>
