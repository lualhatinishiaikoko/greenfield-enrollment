    ...
    <div class="auth-form-inner">
      ...
      <form method="POST" action="lms_login">
        ...
        <div class="field-options">
          ...
          <a class="forgot-link" href="<?= APP_URL ?>/roles/student/portal/student_forgotpassword">Forgot password?</a>
        </div>
      ...
      <div class="switch-role">Looking for the Student Portal? <a href="<?= APP_URL ?>/roles/student/portal/student_login">Log in here</a></div>
    </div>
  </div>
