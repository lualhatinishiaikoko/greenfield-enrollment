...
<?php else: ?>
  <?php
    include_once $is_lms_mode ? BASE_PATH . '/shared/includes/lms_sidebar.php' : BASE_PATH . '/shared/includes/student_sidebar.php';
    ...
    // now (re-checked live) — see roles/student/portal/student_schedule.php for
