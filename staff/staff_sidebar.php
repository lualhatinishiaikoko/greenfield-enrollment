...
<script src="<?= $base ?>js/tab_guard.js?v=<?= filemtime(__DIR__ . '/../js/tab_guard.js') ?>" data-token="<?= htmlspecialchars($_SESSION['sg_tab_token'] ?? '', ENT_QUOTES) ?>" data-logout-url="<?= $base ?>logout"></script>
